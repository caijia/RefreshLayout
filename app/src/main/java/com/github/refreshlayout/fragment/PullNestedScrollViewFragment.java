...
public class PullNestedScrollViewFragment extends Fragment implements RefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_pull_nestedscrollview, container, false);
        return view;
    }
